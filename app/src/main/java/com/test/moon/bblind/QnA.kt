...
{
    val arr :Array<String> = arrayOf("블라블라를 통해 좋은 인연 만드셨나요? 더 나은 서비스를 제공하도록 노력하는 블라블라가 되겠습니다.\n" +
            "삭제 방법은 내 신청현황, 채팅방을 모두 삭제 후에 '회원탈퇴' 버튼을 눌러서 이용이 가능합니다.\n",
            "블라블라를 통해 좋은 인연을 만들 준비 되셨나요? 더 나은 서비스를 제공하도록 노력하는 블라블라가 되겠습니다.\n" +
            ...
            "어플리케이션의 왼쪽 메뉴 바에 알림설정을 통해 푸시알림을 키고 끌 수 있습니다.\n" +
                    "그래도 해결되지 않는 경우에는 휴대폰의 설정->알림 -> 블라블라의 알림을 꺼두시면 알림이 오지 않습니다.",
