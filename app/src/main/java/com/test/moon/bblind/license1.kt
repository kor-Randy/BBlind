...
class license1 : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       val str : String = "서비스 이용약관\n" +
               " \n" +
               "제 1 조 목적\n" +
               "이 약관은 2DBF(이하 \"회사\")에서 제공하는 \"위팅\"에서 제공하는 제반 서비스(이하 \"서비스\")에 접속과 사용자에 의해서 업로드 및 다운로드 되어 표시되는 모든 정보, 텍스트, 이미지 및 기타 자료를 이용하는 이용자(이하 \"회원\")와 서비스 이용에 관한 권리 및 의무와 책임사항, 기타 필요한 사항을 규정하는 것을 목적으로 합니다.\n" +
               " \n" +
               "제2조 약관의 게시와 효력, 개정\n" +
               ...
               "8. 하트: 서비스를 이용 또는 구매하기 위해 사용되는 가상의 화폐 단위로서 회원이 대금을 지급하고 구입하는 것을 의미합니다. 또한, 회원이 서비스를 이용하는 행위에 대한 보상으로 회원에게 지급되는 무료 화폐단위를 의미합니다.\n" +
               "\n" +
               " \n" +
               "제5조 이용계약의 체결\n" +
               "1. 이용계약은 회원이 \"위팅\" 서비스 및 제반 서비스에서 제공하는 회원가입 페이지에서 서비스 이용약관에 동의한 후 이용신청을 함으로써 체결됩니다.\n" +
               ...
               "\n" +
               "제9조 하트 및 아이템의 사용 및 소멸\n" +
               "1. 하트 및 아이템은 회사가 제공하는 서비스를 사용할 때 지불 수단으로 이용될 수 있습니다.\n" +
               "2. 회원이 구매한 하트 및 아이템은 해당 회원의 최종 접속일로부터 2년 경과 시 소멸됩니다. 단, 구매한 아이템의 사용 기간이 정해져 있는 경우 해당 기간 내에서만 사용이 불가능합니다.\n" +
               "3. 회사가 회원에게 무상으로 지급한 하트 및 아이템은 해당 회원의 최종 접속일로부터 1년 경과 시 소멸됩니다. 단, 아이템의 사용 기간이 정해져 있는 경우에 해당 기간 내에서만 사용이 가능합니다.\n" +
               "4. 하트의 사용 순서는 회사가 정하는 정책에 따릅니다.\n" +
               " \n" +
               "제10조 회사의 의무\n" +
               ...
               "19. 기타 \"위팅\" 모바일 어플리케이션 또는 온라인 웹 페이지를 통하여 추가로 공지되는 사항에 위배되는 경우\n" +
               ...
               "4. 회사는 회원과 별도로 서면 계약을 체결하여 \"위팅\" 서비스 및 제반 서비스의 브랜드 특성을 이용할 수 있는 명시적인 권리를 부여하지 아니하는 한, 회원에게 회사 또는 \"위팅\" 서비스의 상호, 상표, 서비스표, 로고, 도메인 네임 및 기타 식별력 있는 브랜드 특성을 이용할 수 있는 권리를 부여하지 않습니다.\n" +
               "5. \"위팅\" 에서 제공하는 서비스는 계속 발전하고 있습니다. 회사가 제공하는 서비스의 형태와 기능, 디자인 등 필요한 경우 수시로 변경되거나, 중단될 수 있습니다. 회사는 이 경우 개별적인 변경에 대해서 회원에게 사전 통지하지 않습니다. 다만, 회원에게 불리한 것으로 판단되는 경우 공지 또는 전자우편으로 통하여 이를 공지합니다.\n" +
               ...
               "3. 회사는 \"위팅\"을 기반으로 한 거래시스템만을 제공할 뿐이며, 거래 내용에 관한 모든 분쟁에 대해서는 해당 거래 당사자가 책임을 져야 합니다.\n" +
               " \n" +
               "제19조 책임제한\n" +
