...
class license1 : AppCompatActivity()
{
    @SuppressLint("ObsoleteSdkInt")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_license1)
       val tv : TextView = findViewById(R.id.license1_put)
       val str : String = "서비스 이용약관\n" +
               " \n" +
               "제 1 조 목적\n" +
               "이 약관은 2DBF(이하 \"회사\")에서 제공하는 \"블라블라\"에서 제공하는 제반 서비스(이하 \"서비스\")에 접속과 사용자에 의해서 업로드 및 다운로드 되어 표시되는 모든 정보, 텍스트, 이미지 및 기타 자료를 이용하는 이용자(이하 \"회원\")와 서비스 이용에 관한 권리 및 의무와 책임사항, 기타 필요한 사항을 규정하는 것을 목적으로 합니다.\n" +
               " \n" +
               "제2조 약관의 게시와 효력, 개정\n" +
               ...
               " \n" +
               "제4조 용어의 정의\n" +
               "1. 서비스: 개인용 컴퓨터 (PC), TV, 휴대형 단말기, 전기통신설비 등 포함 각종 유무선 장치와 같이 구현되는 단말기와 상관없이 회원이 이용할 수 있는 \"블라인드\" 관련 제반 서비스를 의미합니다.\n" +
               "2. 회원: 회사와 서비스 이용계약을 체결하고 회사가 제공하는 서비스를 이용하는 모든 사용자를 의미합니다.\n" +
               "3. 계정: 회원이 가입할 때 입력한 본인의 정보들과 고유한 번호를 서비스를 이용할 수 있게 한 조합을 의미합니다.\n" +
               "4. 닉네임: 회원이 가입할 때 입력한 회원 본인의 별명를 의미합니다.\n" +
               ...
               "8. 마카롱: 서비스를 이용 또는 구매하기 위해 사용되는 가상의 화폐 단위로서 회원이 대금을 지급하고 구입하는 것을 의미합니다. 또한, 회원이 서비스를 이용하는 행위에 대한 보상으로 회원에게 지급되는 무료 화폐단위를 의미합니다.\n" +
               "\n" +
               " \n" +
               "제5조 이용계약의 체결\n" +
               "1. 이용계약은 회원이 \"블라블라\" 서비스 및 제반 서비스에서 제공하는 회원가입 페이지에서 서비스 이용약관에 동의한 후 이용신청을 함으로써 체결됩니다.\n" +
               "2. 회사는 이용약관에 동의한 후 이용신청한 사용자에 대해서 원칙적으로 서비스 이용을 승낙함을 원칙으로 합니다. 다만 업무 수행상 또는 기술상 지장이 있을 경우 일정시간 가입승인을 유보할 수 있습니다.\n" +
               "3. 회사는 다음 각 호에 해당하는 신청에 대해서 승낙하지 않거나 사후에 이용계약을 해지할 수 있습니다.\n" +
               "4. 가입신청자가 이 약관에 의하여 이전에 회원자격을 상실한 적이 있는 경우\n" +
               "5. 허위의 정보를 기재하거나, 회사가 필수적으로 입력을 요청한 부분을 기재하지 않은 경우\n" +
               "6. 부정한 용도로 서비스를 사용하고자 하는 경우\n" +
               "7. 이용자의 귀책사유로 인하여 승인이 불가능하거나 기타 규정한 제반 사항을 위반하며 신청하는 경우\n" +
               "8. 회사의 정책에 적합하지 않는 회원으로 판단되는 경우나 서비스 제공이 곤란한 경우\n" +
               "9. 회원의 이용 목적이나 서비스 이용 방법이 회사의 재산권이나 영업권을 침해하거나 침해할 우려가 있는 경우\n" +
               "10. 비정상적인 방법을 통하여 아이디 및 도메인을 대량으로 생성하는 행위\n" +
               "11. 회원은 회원 가입 시 기재한 개인정보의 내용에 변경이 발생한 경우, 즉시 변경사항을 정정하여 기재하여야 합니다. 변경의 지체로 인하여 발생한 회원의 손해에 대해 회사는 책임을 지지 않습니다.\n" +
               "12. 회사는 관련 법률 및 회사의 개인정보취급방침에서 정한 바에 따라 회원에게 요청하는 회원정보 및 기타정보 항목을 추가, 삭제 등 변경하여 수집 및 이용할 수 있습니다.\n" +
               " \n" +
               "제6조 개인정보보호 의무\n" +
               ...
               " \n" +
               "제7조 회원의 아이디 및 비밀번호\n" +
               "1. 회원은 계정에 관해서 관리책임이 있습니다.\n" +
               "2. 회원은 계정를 제3자가 이용하도록 제공하여서는 안됩니다.\n" +
               "3. 회사는 회원이 계정을 소홀히 관리하여 발생하는 서비스 이용상의 손해 또는 회사의 고의 또는 중대한 과실이 없는 제3자의 부정이용 등으로 인한 손해에 대해 책임을 지지 않습니다.\n" +
               "4. 회원은 계정가 도용되거나 제3자가 사용하고 있음을 인지한 경우에는 이를 즉시 회사에 통지하고 회사의 안내에 따라야 합니다.\n" +
               " \n" +
               "제8조 결제, 환불 및 결제 취소\n" +
               ...
               "a. 환불을 원하는 회원은 전자 우편을 통해 회원 본인임을 인증하는 절차를 거쳐 고객센터에 접수하셔야 하며 본인 인증과 동시에 환불을 신청하여야 합니다.\n" +
               "b. 회사는 회원이 환불 요청 사유가 적합한지를 판단하고 3항의 환불사유가 존재하고, 적합한 절차를 거친 것으로 판명된 회원에게 환불합니다.\n" +
               "c. 회사는 회원에게 환불되어야 할 금액 산정 방식과 절차를 회원에게 상세히 설명하고 난 후 회원에게 해당 환불 및 결제 취소 처리합니다.\n" +
               "d. 회원은 구매시점으로부터 7일 이내인 경우 환불이 가능하며 구매시점 7일 이후에는 시스템 오류로의 미지급 등 회사의 귀책사유로 인정되는 경우에만 환불이 가능합니다.\n" +
               ...
               "8. 회사와 이용자간에 발생한 분쟁은 전자거래기본법 제32조에 의거하여 설치된 기관인 전자거래분쟁조정위원회의 조정에 따를 수 있습니다.\n" +
               "\n" +
               "제9조 마카롱 및 아이템의 사용 및 소멸\n" +
               "1. 마카롱 및 아이템은 회사가 제공하는 서비스를 사용할 때 지불 수단으로 이용될 수 있습니다.\n" +
               "2. 회원이 구매한 마카롱 및 아이템은 해당 회원의 최종 접속일로부터 2년 경과 시 소멸됩니다. 단, 구매한 아이템의 사용 기간이 정해져 있는 경우 해당 기간 내에서만 사용이 불가능합니다.\n" +
               "3. 회사가 회원에게 무상으로 지급한 마카롱 및 아이템은 해당 회원의 최종 접속일로부터 1년 경과 시 소멸됩니다. 단, 아이템의 사용 기간이 정해져 있는 경우에 해당 기간 내에서만 사용이 가능합니다.\n" +
               "4. 마카롱의 사용 순서는 회사가 정하는 정책에 따릅니다.\n" +
               " \n" +
               "제10조 회사의 의무\n" +
               ...
               "19. 기타 \"블라블라\" 모바일 어플리케이션 또는 온라인 웹 페이지를 통하여 추가로 공지되는 사항에 위배되는 경우\n" +
               "20. 회사는 회원이 전항에서 금지한 행위를 하는 경우, 위반 행위의 경중에 따라 서비스의 이용정지/계약의 해지 등 서비스 이용 제한, 수사 기관에의 고발 조치 등 합당한 조치를 취할 수 있습니다.\n" +
               "21. 회원은 회사의 명시적 사전 동의가 없는 한 서비스의 이용권한 및 기타 이용계약상의 지위를 제3자에게 양도, 증여, 대여할 수 없으며 이를 담보로 제공할 수 없습니다.\n" +
               "22. 회원은 관계법, 이 약관의 규정, 이용안내 및 서비스와 관련하여 공지한 주의사항, 회사가 통지하는 사항 등을 준수하여야 하며, 기타 회사의 업무에 방해되는 행위를 하여서는 안 됩니다.\n" +
               "23. 회원은 회사의 사전 허락 없이 회사가 정한 이용 목적과 방법에 반하여 영업/광고활동 등을 할 수 없고, 회원의 서비스 이용이 회사의 재산권, 영업권 또는 비즈니스 모델을 침해하여서는 안됩니다.\n" +
               " \n" +
               "제12조 서비스의 제공 및 변경\n" +
               ...
               "4. 회사는 회원과 별도로 서면 계약을 체결하여 \"블라블라\" 서비스 및 제반 서비스의 브랜드 특성을 이용할 수 있는 명시적인 권리를 부여하지 아니하는 한, 회원에게 회사 또는 \"블라블라\" 서비스의 상호, 상표, 서비스표, 로고, 도메인 네임 및 기타 식별력 있는 브랜드 특성을 이용할 수 있는 권리를 부여하지 않습니다.\n" +
               "5. \"블라블라\" 에서 제공하는 서비스는 계속 발전하고 있습니다. 회사가 제공하는 서비스의 형태와 기능, 디자인 등 필요한 경우 수시로 변경되거나, 중단될 수 있습니다. 회사는 이 경우 개별적인 변경에 대해서 회원에게 사전 통지하지 않습니다. 다만, 회원에게 불리한 것으로 판단되는 경우 공지 또는 전자우편으로 통하여 이를 공지합니다.\n" +
               ...
               "3. 회원의 관리 소홀로 인하여 계정의 유출로 인해 회원에게 서비스 이용상의 손해가 발생하거나 제3자에 의한 부정이용 등으로 회원의 의무조항을 위반한 경우 ID및 해당 도메인의 이용이 제한될 수 있습니다.\n" +
               "4. 회사가 본 약관 제11조의 위반 행위를 조사하는 과정에서 당해 회원 ID 및 도메인이 특정 위반행위에 직접적으로 관련되어 있는 경우 등 다른 회원의 권익 보호 및 서비스의 질서유지를 위해 불가피할 경우에는 해당 ID 및 도메인의 이용을 일시적으로 정지할 수 있습니다. 이에 대해 회원은 \"아만다\" 서비스 홈페이지 또는 전자우편 등을 통해 이의신청을 할 수 있습니다.\n" +
               " \n" +
               "제16조 게시물의 권리와 책임\n" +
               ...
               "3. 회사는 \"블라블라\"를 기반으로 한 거래시스템만을 제공할 뿐이며, 거래 내용에 관한 모든 분쟁에 대해서는 해당 거래 당사자가 책임을 져야 합니다.\n" +
               " \n" +
               "제19조 책임제한\n" +
               ...
               " \n" +
               "본 서비스는 방심위의 ‘청소년 보호 활동 강화 권고안'의 규정을 준수한다. 본 서비스에서 성매매와 청소년에게 유해한 활동이 있을 수 있음을 주의하고, 아동, 청소년 포함 성매매를 알선, 권유, 유인, 강요하는 사람이나 성매매를 한 사람은 형사처벌의 대상임을 고지한다."
