...
class license2 : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tv: TextView = findViewById(R.id.license2_put)
        val str : String = "2DBF(이하 “회사”라 함)는 개인정보 보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률 등 정보통신서비스제공자가 준수하여야 할 관련 법령상의 개인정보보호 규정을 준수하며, 관련 법령에 의거한 개인정보취급방침을 정하여 회원 권익 보호에 최선을 다하고 있습니다. 회사의 개인정보취급방침은 다음과 같은 내용을 담고 있습니다.\n" +
                "\n" +
                "1. 수집하는 회원의 개인정보\n" +
                "2. 개인정보의 수집 및 이용목적\n" +
                "3. 개인정보를 수집하는 방법\n" +
                ...
                "11. 인지 못한 회원의 개인정보 및 기타 불만사항에 관한 처리\n" +
                ...
                "가. 수집하는 개인정보의 항목\n" +
                "\n" +
                "-필수항목: ID(고유번호), 성별, 휴대폰번호 등의 정보는 정보주체가 그 수집에 동의하는 경우 수집됩니다.\n" +
                "-선택항목: 별명 등의 정보는 정보주체가 그 수집에 동의하는 경우 수집됩니다.\n" +
                "-종교, 병역사항, 연봉, 차량, 주거형태, 신장, 몸무게, 시력, 혈액형, 흡연, 음주, 혼인이력 등은 추가서비스 및 설문조사를 통해 다양한 정보 수집 및 제공에 필요시 정보주체가 그 수집에 동의하는 경우 추가로 수집될 수 있습니다.\n" +
                "\n" +
                ...
                "6) 상품권 이용시: 상품권 번호 등\n" +
                "7) 서비스 사용 중일 때 귀하의 모바일 기기의 지리적 위치\n" +
                "8) 모바일 단말기 정보, 국가정보 (MCC)\n" +
                "9) 광고 식별자 정보 (ADID, IDFA)\n" +
                "\n" +
                "나. 개인정보 수집방법\n" +
                ...
                "나. 개인정보의 처리를 위탁하는 경우에는 위탁계약 등을 통하여 서비스제공자의 개인정보보호 관련 지시엄수, 개인정보에\n" +
                ...
                "\n" +
                "7. 회원 개인정보 정확성을 위한 내용\n" +
                "회사는 회원이 개인정보를 최신의 상태로 유지하도록 정기적으로 갱신을 유도합니다. 일부 정보에 대해서는 정기적으로 확인작업이 이루어 집니다. 회원의 부정확한 개인정보로 인하여 사용상의 불편을 줄 수 있으므로 개인정보 관리자가 판단하기에\n" +
                "확연히 부정확한 개인정보를 기입한 경우에는 정확하지 않은 개인정보를 파기할 수 있습니다.\n" +
                "\n" +
                "8. 회원의 개인정보안전을 위해 취해질 수 있는 서비스 일시 중단조치\n" +
                ...
                "\n" +
                "10. 회원의 개인정보 비밀유지를 위한 내용\n" +
                "회사는 회원의 개인정보의 비밀을 유지하기 위하여 제3자에게는 회원의 동의 없이 개인정보를 유출하지 않습니다. 또한 회원이 동의를 하였다 하더라도, 제3자를 통하여 재유출이 될 확률이 있는 자에게는 회원의 개인정보를 유출하지 않습니다. 회사는 각종 정부기관의 회원 개인정보의 일방적 제공 요구에 대하여는 회원의 개인정보를 제공하지 않습니다. 법령에 따른 정부기관이 법령에 따른 공식 절차를 완벽하게 거쳐 자료를 요구하는 경우에 한하여 회원의 개인정보를 제공합니다. 회사는 회원의 개인정보를 회사가 정한 기본서비스 및 기타의 서비스 활동 이외에는 이용하지 않습니다. 위의 활동에 따라 회원의 정보가\n" +
                "필요할 시에는 별도의 양식을 통한 수집 및 동의의 절차를 거쳐서 회원의 개인정보를 이용합니다.\n" +
                "\n" +
                ...
                "\n" +
                "12. 개인정보 취급자의 제한에 관한 내용\n" +
                "회사는 제한된 소수의 직원에게만 회원의 개인정보를 취급할 권한을 부여하고 개인정보를 보호하는데 최선을 다합니다.\n" +
                "\n" +
                "13. 회원 및 법정대리인의 권리와 그 행사방법\n" +
                ...
                "\n" +
                "부칙\n" +
                "1. 본 개인정보취급방침은 2019년 9월 2일 부터 적용됩니다."
